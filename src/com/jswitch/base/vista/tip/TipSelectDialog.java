package com.jswitch.base.vista.tip;
...
class TipSelectDialog extends JDialog {
    ...
    private void init() {
        ...
        controlFilter.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                ...
                if (e.getKeyCode() == KeyEvent.VK_ENTER && System.currentTimeMillis() > t + 1000) {
    ...
    private void jbInit() throws Exception {
        ...
        filterPanel.add(labelFilter, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 5, 0, 5), 0, 0));
        filterPanel.add(controlFilter, new GridBagConstraints(1, 0, 1, 1, 1.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 5, 5), 0, 0));
        filterPanel.add(labelTitle, new GridBagConstraints(0, 1, 2, 1, 0.0, 0.0, GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 5, 0, 5), 0, 0));
