 ...
 * @author bc
 */
public class OficinaDetailFrame extends DefaultDetailFrame {

    public OficinaDetailFrame() {
    }
    ...
    private void initComponents() {
        ...
        form1.setVOClassName(Oficina.class.getName());
        ...
        labelControl4.setLabel("telefono");

        textControl4.setAttributeName("telefono");

        labelControl5.setLabel("direccion");

        textControl5.setAttributeName("direccion");

        labelControl7.setLabel("responsable");

        textControl7.setAttributeName("responsable");

        labelControl8.setLabel("obserbacion");

        textControl8.setAttributeName("observacion");
