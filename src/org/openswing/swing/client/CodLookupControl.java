...
public class CodLookupControl extends BaseInputControl implements CodBoxContainer, InputControl, LookupParent, AutoCompletitionInputControl {
    ...
    /**  */ //bc
    private JButton openButton = new JButton() {//bc
    ...
    public CodLookupControl() {
        ...
        openButton.setEnabled(false);//bc
        openButton.addActionListener(new ActionListener() {//bc
        ...
        openButton.setPreferredSize(new Dimension(lookupButton.getPreferredSize().width, codBox.getPreferredSize().height));//bc
        openButton.setMaximumSize(new Dimension(lookupButton.getPreferredSize().width, codBox.getPreferredSize().height));//bc
        openButton.setMinimumSize(new Dimension(lookupButton.getPreferredSize().width, codBox.getPreferredSize().height));//bc
...
//    this.add(lookupButton);
    ...
    public final void setColumns(int columns) {
        ...
        StringBuffer s = new StringBuffer(columns);
